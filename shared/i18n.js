...
const I18N_DICT = {
  ...
  noticeLabel:{ko:'공지',zh:'公告',en:'Notice',ja:'お知らせ',vi:'Thông báo'},
  roundNoLabel:{ko:'라운드 번호',zh:'局號',en:'Round No.',ja:'ラウンド番号',vi:'Số ván'},
  shoeNoLabel:{ko:'슈 번호',zh:'靴號',en:'Shoe No.',ja:'シュー番号',vi:'Số shoe'},
