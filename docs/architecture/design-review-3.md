...
| ID | 항목 | 등급 | 영향 | 근거 |
|---|---|---|---|---|
| [DR-38](#dr-38) | 선언만 있고 op 함수가 없는 도메인 4개 — 앱이 기록할 방법이 없다 | **차단** | M1 | `001:86-92` · `009`~`011` 전수 |
| [DR-39](#dr-39) | 4-eyes 승인 임계가 기본값 NULL — 승인이 한 번도 발동하지 않는다 | **차단** | M1 | `001:204` · `001:209` · `009:99` |
