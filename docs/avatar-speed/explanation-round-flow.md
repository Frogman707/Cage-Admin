...
| | 아바타 | 스피드 |
| --- | --- | --- |
| `betting` | **30초** — 지시가 자동 주입됨 | **15초** — 회원이 칩을 놓음 |
| `dealing` | **4초** — `placeBet` × N, 카드 공개 | **3초** — `placeBet` × N, 카드 공개 |
...
안 하면 XSS가 됩니다. 채팅 렌더링([`avatar/app.js:848`](../../avatar/app.js#L848))과 로비 카드
([`avatar/app.js:439`](../../avatar/app.js#L439))가 이를 지킵니다.
