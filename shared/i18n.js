...
const I18N_DICT = {
  ...
  gameTypeHyper:{ko:'하이퍼',zh:'Hyper',en:'Hyper',ja:'ハイパー',vi:'Hyper'},
  gameTypeDragonTiger:{ko:'드래곤 타이거',zh:'龙虎',en:'Dragon Tiger',ja:'ドラゴンタイガー',vi:'Dragon Tiger'},
  gameComingSoon:{ko:'준비 중인 게임입니다',zh:'即将推出',en:'Coming soon',ja:'近日公開',vi:'Sắp ra mắt'},
  ...
  bigRoad:{ko:'빅로드',zh:'大路',en:'Big Road',ja:'ビッグロード',vi:'Big Road'},
  bigEyeBoy:{ko:'빅아이보이',zh:'大眼仔',en:'Big Eye Boy',ja:'ビッグアイボーイ',vi:'Big Eye Boy'},
  smallRoad:{ko:'스몰로드',zh:'小路',en:'Small Road',ja:'スモールロード',vi:'Small Road'},
  cockroachRoad:{ko:'칵로치로드',zh:'蟑螂路',en:'Cockroach Road',ja:'ローチロード',vi:'Cockroach Road'},
  beadPlate:{ko:'진주 로드',zh:'珠盘路',en:'Bead Plate',ja:'パールロード',vi:'Bead Plate'},
  dealsLabel:{ko:'게임 횟수',zh:'局數',en:'Deals',ja:'ゲーム回数',vi:'Số ván'},
  nextGameTrend:{ko:'다음 게임 동향',zh:'下局預告',en:'Next Game Trend',ja:'次ゲーム傾向',vi:'Xu hướng ván tiếp theo'},
  roadDisclaimer:{ko:'표시되는 결과는 참고용 서비스이며, 오기재에 대해 당사는 책임지지 않습니다.',zh:'显示结果仅供参考，本公司对错误记录概不负责。',en:'Results displayed are provided as a reference service only; we are not responsible for incorrect entries.',ja:'表示される結果は参考サービスであり、誤記載について当社は責任を負いません。',vi:'Kết quả hiển thị chỉ mang tính tham khảo; chúng tôi không chịu trách nhiệm về sai sót.'},
  recentResults:{ko:'최근 결과',zh:'最近结果',en:'Recent Results',ja:'最近の結果',vi:'Kết quả gần đây'},
