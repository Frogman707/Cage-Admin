...
const I18N_DICT = {
  ...
  aiRecommendation:{ko:'AI 추천',zhHans:'AI 推荐',zhHant:'AI 推薦',en:'AI recommendation',ja:'AIの推奨',vi:'AI đề xuất'},
  aiExpectedValue:{ko:'기대값',zhHans:'期望值',zhHant:'期望值',en:'Expected value',ja:'期待値',vi:'Giá trị kỳ vọng'},
  aiConfidence:{ko:'신뢰도',zhHans:'置信度',zhHant:'信賴度',en:'Confidence',ja:'信頼度',vi:'Độ tin cậy'},
  aiMarginLabel:{ko:'오차범위',zhHans:'误差范围',zhHant:'誤差範圍',en:'Margin of error',ja:'誤差範囲',vi:'Sai số'},
  aiCardsLeft:{ko:'남은 카드',zhHans:'剩余牌',zhHant:'剩餘牌',en:'Cards left',ja:'残りカード',vi:'Bài còn lại'},
  aiWaiting:{ko:'다음 라운드를 기다리는 중입니다.',zhHans:'正在等待下一局。',zhHant:'正在等待下一局。',en:'Waiting for the next round.',ja:'次のラウンドを待っています。',vi:'Đang chờ ván tiếp theo.'},
  aiNoShoe:{ko:'슈가 곧 교체됩니다. 남은 카드가 부족해 계산할 수 없습니다.',zhHans:'牌靴即将更换，剩余牌不足以计算。',zhHant:'牌靴即將更換，剩餘牌不足以計算。',en:'The shoe is about to change - too few cards left to compute.',ja:'シューがまもなく交換されます。残り枚数が足りず計算できません。',vi:'Sắp đổi shoe - còn quá ít bài để tính.'},
  aiConf_high:{ko:'높음',zhHans:'高',zhHant:'高',en:'High',ja:'高',vi:'Cao'},
  aiConf_normal:{ko:'보통',zhHans:'中',zhHant:'中',en:'Normal',ja:'普通',vi:'Trung bình'},
  aiConf_low:{ko:'낮음',zhHans:'低',zhHant:'低',en:'Low',ja:'低',vi:'Thấp'},
  aiConf_none:{ko:'없음',zhHans:'无',zhHant:'無',en:'None',ja:'なし',vi:'Không'},
  aiNoteResolved:{ko:'남은 카드 구성이 양쪽 기대값 차이를 오차범위 밖으로 벌렸습니다.',zhHans:'剩余牌组成使两边期望值之差超出误差范围。',zhHant:'剩餘牌組成使兩邊期望值之差超出誤差範圍。',en:'The remaining cards put the two sides further apart than the margin of error.',ja:'残りカードの構成で、両者の期待値差が誤差範囲を超えました。',vi:'Bài còn lại tạo chênh lệch kỳ vọng vượt sai số.'},
  ...
  // the two figures a line of the record reconciles between: what the player had going
  // into that bet and what they had coming out of it
  balBefore:{ko:'베팅 전',zhHans:'投注前',zhHant:'投注前',en:'Before',ja:'ベット前',vi:'Trước cược'},
  balAfter:{ko:'베팅 후',zhHans:'投注后',zhHant:'投注後',en:'After',ja:'ベット後',vi:'Sau cược'},
  ...
  colGameType:{ko:'게임타입',zhHans:'游戏类型',zhHant:'遊戲類型',en:'Game Type',ja:'ゲームタイプ',vi:'Loại trò chơi'},
